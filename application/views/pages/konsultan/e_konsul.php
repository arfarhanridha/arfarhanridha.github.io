        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    ...
                    <!-- form start -->
                    <form method="post" enctype="multipart/form-data" action="<?= base_url('konsultan/proses_edit_transaksi'); ?>">
                        <div class="box-body">
                            <div class="row">
                                ...
                                <div class="col-md-4 mb-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="tema" class="form-control" value="<?= $tema_pertemuan ?>" readonly>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-md-4 mb-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="desk" class="form-control" value="<?= $desk_konsultasi ?>" readonly>
                                    </div>
                                </div>
                                <div class="col-md-4 mb-3">
                                    <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-md-4 mb-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="frekuensi" class="form-control" value="<?= $frekuensi_pertemuan ?>" readonly>
                                    </div>
                                </div>
                                <div class="col-md-4 mb-3">
                                    <div class="form-group">
                                        <label for="">Keterangan</label>
                                        <input type="text" name="ket" class="form-control" value="<?= $keterangan ?>">
                                    </div>
                                </div>
                                <div class="col-md-4 mb-3">
                                    <div class="form-group">
