        ...
        <div class="col-xs-12">
            <div class="box box-primary">
                <div class="box-header">
                    ...
                    <h3 class="box-title">Konsultasi Klient Anda</h3>
                    <div class="box-tools">
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu" role="menu">
                                                <li><a href="<?= base_url('konsultan/detail_transaksi/' . $data->kode_transaksi); ?>">Detail</a></li>
                                                <li><a href="<?= base_url('konsultan/edit_transaksi/' . $data->kode_transaksi); ?>">Edit</a></li>
                                            </ul>
                                        </div>
                                    </td>
                                </tr>
