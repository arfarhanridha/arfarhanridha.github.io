                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 mb-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="nama_konsultan" class="form-control" value="<?= $nama_konsultan ?>" readonly>
                                    </div>
                                </div>
                                <div class="col-md-4 mb-3">
                                    <div class="form-group">
                                        <label for="">Email Konsultan</label>
                                        <input type="text" name="email_konsultan" class="form-control" value="<?= $email_konsultan ?>" readonly>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-md-4 mb-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="fakultas" class="form-control" value="<?= $fakultas ?>" readonly>
                                    </div>
                                </div>
                                <div class="col-md-4 mb-3">
                                    <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-md-4 mb-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="keahlian" class="form-control" value="<?= $keahlian ?>" readonly>
                                    </div>
                                </div>
                                <div class="col-md-4 mb-3">
                                    <div class="form-group">
